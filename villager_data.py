...
def all_species(filename):
    ...
    unique_species = set()
    for  villager in all_data(filename):
        unique_species.add(villager[1])
...
def get_villagers_by_species(filename, search_string="All"):
    ...
    # villagers = []
    # # data = open(filename)
    # for  villager in get_villagers_by_species(filename):
    #     species = villager.rstrip().split("|")[:2]
    #     if search_string in( "All", species):
...
def all_data(filename):
    ...
    data = open(filename)
    for line in data:
        villager_name=tuple(line.split("|"))
        all_data.append(villager_name)
...
def find_motto(filename, villager_name):
    ...
    return find_motto(villager_name)
...
print(find_likeminded_villagers("villagers.csv"))
